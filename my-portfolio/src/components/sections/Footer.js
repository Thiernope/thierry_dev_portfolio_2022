...
const Footer = () => {
  return (
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to ="https://flowbite.com" class="hover:underline">Thiernope</Link>. All Rights Reserved.
        </span>
