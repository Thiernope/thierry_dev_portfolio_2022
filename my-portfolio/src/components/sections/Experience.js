...
{ showModal &&
<div class="fixed top-0 left-0 right-0 z-50 bg-black w-full p-4 dark:bg-white overflow-y-auto md:inset-0 h-modal md:h-full">
...
<div role="status">
    ...
    <div class="ml-3 text-sm font-normal">Downloading...</div>
</div>

  }

  
    <div id='myCv' class="relative w-full h-full max-w-2xl md:h-auto m-auto">
        {/* <!-- Modal content --> */}
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            {/* <!-- Modal header --> */}
            {showOnPrinting && 
             <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 onClick={generateInvoicePDF} class="text-xl font-semibold text-gray-900 dark:text-white cursor-pointer hover:underline hover:text-blue-400">
                   Download
                </h3>
                <button onClick={() => setShowModal(false)}  class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white">
