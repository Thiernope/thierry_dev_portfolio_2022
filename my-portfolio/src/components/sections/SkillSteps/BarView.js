...
import {barChartData, barOptions } from "./SkillsData"
import Typical from "react-typical"
import "./Skills.css"
import { Bar } from "react-chartjs-2";
import Chart from 'chart.js/auto'
Chart.register();
const BarView = ({showPolarAreaChart, showLineChart, showBarChart, showCssChart}) => {
...
<div className="mt-10 md:mt-0 flex justify-start sm:justify-center">
    ...
    <ul className="flex flex-wrap -mb-px">
        <li className="mr-2" onClick={showPolarAreaChart}>
            <p className="inline-block px-1 py-4 sm:p-4 md:px-10 md:py-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300">Dougnut</p>
        </li>
        ...
        <li className="mr-2" onClick={showBarChart}>
            <p className="inline-block px-1 py-4 sm:p-4 md:px-10 md:py-4text-blue-600 rounded-t-lg border-b-2 border-blue-600 active dark:text-blue-500 dark:border-blue-500">Bar</p>
        </li>
